...
Of course, while the `expect(callable ...$methods)` method addresses most of the traditional mocking needs, you may have more complex cases that require to use the underyling Mockery mock instance:
